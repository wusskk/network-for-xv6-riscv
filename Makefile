...
QEMUOPTS += -netdev user,id=net0,hostfwd=tcp::50000-:40000 -object filter-dump,id=net0,netdev=net0,file=packets.pcap
...
qemu-dtb: $K/kernel fs.img
	$(QEMU) $(QEMUOPTS) -machine dumpdtb=riscv64-virt.dtb
